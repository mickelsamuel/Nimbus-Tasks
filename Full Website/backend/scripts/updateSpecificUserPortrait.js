...
async function updateSpecificUserPortrait(email) {
  try {
    // Connect to MongoDB
    ...
    // Update portrait URL to use the proper halfbody-portrait scene
...
if (!email) {
  console.log('Usage: node updateSpecificUserPortrait.js <email>');
  process.exit(1);
}

updateSpecificUserPortrait(email);