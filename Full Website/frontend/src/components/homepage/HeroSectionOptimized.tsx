...
// Memoized dashboard preview component
const DashboardPreview = memo(({ previewLoading, preview }: { previewLoading: boolean; preview: any }) => {
  const { ref, hasBeenInView } = useInViewport({ threshold: 0.3 })
  
  if (!hasBeenInView) {
    return (
      <div ref={ref as any} className="relative hidden lg:block h-[600px]">
      ...
      <div className="relative">
        ...
        <div className="absolute -top-8 -right-8 bg-white dark:bg-gray-800 rounded-2xl perf-shadow-md p-6 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="text-lg font-bold text-gray-900 dark:text-white">Enterprise Ready</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Trusted by 500+ institutions</div>
            </div>
          </div>
        </div>
        ...
        <div className="absolute -bottom-6 -left-6 bg-white dark:bg-gray-800 rounded-2xl perf-shadow-md p-6 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="text-lg font-bold text-gray-900 dark:text-white">AI-Powered</div>
              <div className="text-sm text-gray-600 dark:text-gray-400">Personalized learning paths</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="relative overflow-hidden min-h-screen flex items-center bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-slate-950 dark:via-blue-950 dark:to-purple-950">
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <DashboardPreview previewLoading={previewLoading} preview={preview} />
        </div>
      </motion.div>
    </section>
  )
